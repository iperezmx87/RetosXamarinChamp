...
namespace RetoN
{
    ...
    public class ToDoActivity : Activity
    {
        ...
        protected override async void OnCreate(Bundle bundle)
        {
            ...
            Gcm.Client.GcmClient.Register(this, ToDoBroadcastReceiver.senderIDs);
            ...
            Services.ServiceHelper client2 = new Services.ServiceHelper();

            ;

            await client2.InsertarEntidad("neomatrixisra25@hotmail.com", "RetoN + cf170 + https://github.com/iperezmx87/RetosXamarinChamp/RetoN", Android.Provider.Settings.Secure.GetString(ContentResolver, Android.Provider.Settings.Secure.AndroidId));
